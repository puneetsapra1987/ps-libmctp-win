...
#ifdef _MSC_VER
/* MSVC: Use a fixed 8-byte alignment which is sufficient for struct mctp_pktbuf */
#define PKTBUF_STORAGE_ALIGN_DECL __declspec(align(8))
#define PKTBUF_STORAGE_ALIGN
#else
#define PKTBUF_STORAGE_ALIGN_DECL
